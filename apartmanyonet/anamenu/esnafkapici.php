...
<div style="cursor:pointer"  class="w3-container w3-third w3-gray w3-col s4" onclick="openCity('sorunbak')">
   <div  class="w3-left"><i class="fa fa-star-half-o w3-xxxlarge"></i></div>
<div class="w3-clear"></div> 
<p>Esnaf Değerlendir</p>
</div>
...
<select class="w3-input w3-border">
  ...
  <option value="dogalgaz">Dogalğaz</option>
  <option value="boyaci">Boya</option>
  <option value="diger">Diğer</option>
</select>
</p>
<p>      
<label class="w3-text-grey">Talep Şekli</label>
<select class="w3-input w3-border">
  <option value="siradan">Sıradan</option>
  <option value="basarili">Başarılı</option>
  <option value="enkisazaman">Çabuk gelecek</option>
  <option value="enuygun">En Uygun Fiyat Veren</option>
  <option value="listeden">Listeden Seç</option>
</select>
</p>
<p>      
...
<br>
  ...
  <div class="w3-half">
     ...
     <input id="nasilgelsin" class="w3-radio" type="radio" name="sorunbildir" value="hemengelsin" checked>
    <label>Hemen Gelsin</label>
    <br>
    <input id="nasilgelsin" class="w3-radio" type="radio" name="sorunbildir" value="fiyatal" >
    <label>Fiyat Al</label>
    <br>
...
<div style="display:none" id="sorunbak" class="w3-container w3-card-4 sorun">
  <div class="w3-container">
   <label class="w3-text-grey"> <h5>Kategori</h5></label>
<select class="w3-input w3-border">
  ...
  <option value="diger">Diğer</option>
   ...
   <div class="container w3-margin-top w3-margin-bottom"> <!--küçük ekranlar için tekrar ayarlama gerekiyor sonra bakarım inşallah :D -->
    <ul class="w3-ul w3-card-4 w3-white">
      <li class="w3-padding-20">
        <img src="../css/avatar5.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
            <span class="w3-xlarge">Ali </span><span class=" w3-center">-Sucu</span><span  style="color:yellow;" class="w3-right" > <i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star-half-o " ></i><i class=" w3-large fa fa-star-o " ></i><i class=" w3-large fa fa-star-o" ></i><i class=" w3-large fa fa-star-o" ></i></span>
    
      </li>
      <li class="w3-padding-20">
        <img src="../css/avatar1.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
            <span class="w3-xlarge">Faruk </span><span class=" w3-center">-Elektrikçi</span> <span  style="color:yellow;" class="w3-right" > <i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star-half-o" ></i><i class=" w3-large fa fa-star-o" ></i></span>
      </li>
      <li class="w3-padding-20">
        <img src="../css/avatar2.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
            <span class="w3-xlarge">Yunus </span><span class=" w3-center">-Bilgisayarcı</span><span style="color:yellow;" class="w3-right" > <i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star" ></i><i class=" w3-large fa fa-star" ></i></span>
   ...
   <div class="container w3-margin-top w3-margin-bottom">
    <ul class="w3-ul w3-card-4 w3-white">
        ...
        <img src="../css/avatar2.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
         ...
         <li class="w3-padding-20">
        <img src="../css/avatar4.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
            <span class="w3-xlarge">Faruk </span><span class=" w3-center">-Elektrikçi</span> <span  style="color:yellow;" class="w3-right" > <i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star " ></i><i class=" w3-large fa fa-star-half-o" ></i><i class=" w3-large fa fa-star-o" ></i></span>
      </li>
      <li class="w3-padding-20">
        <img src="../css/avatar2.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
