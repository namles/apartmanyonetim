...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s4">
      <img src="../W3.CSS Template_files/avatar2.png" class="w3-circle w3-margin-right" style="width:46px">
    </div>
...
<TABLE FRAME=VOID CELLSPACING=0 COLS=5 RULES=NONE BORDER=0>
	...
	<TBODY>
		...
		<TR>
			...
			<TD class="w3-border w3-border-black" COLSPAN=3 ALIGN=CENTER ><input style="border-bottom:none" class="w3-input" type="date"/></TD>
